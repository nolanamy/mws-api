    ...
    Outbound: {
        ...
        CreateFulfillmentOrder: {
            params: {
                ...
                FulfillmentAction: { name: 'FulfillmentAction' },
                ...
                LineItems: { name: 'Items.member', list, required, type: Type.COMPLEX, params: {
                    Quantity: { name: 'Quantity', required, type: Type.INTEGER },
                    SellerFulfillmentOrderItemId: { name: 'SellerFulfillmentOrderItemId', required },
                    SellerSKU: { name: 'SellerSKU', required }
                } }
            }
        },
